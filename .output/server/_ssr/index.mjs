...
import { u as resolveManifestAssetLink, v as rootRouteId, w as getNormalizedURL, x as getOrigin, y as attachRouterServerSsrUtils, z as defineHandlerCallback, A as createSerializationAdapter, C as createRawStreamRPCPlugin, D as invariant, E as isNotFound, F as isRedirect, G as isResolvedRedirect, H as mergeHeaders, I as executeRewriteInput, J as defaultSerovalPlugins, K as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-OlJYNANZ.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CetSUMdE.mjs").then((n) => n.router),
